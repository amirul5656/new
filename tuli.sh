...
screen -dmS "$RAND_NAME" bash -c "cd /root/new && ./unmi --algorithm m7m --pool stratum+tcp://m7m.sea.mine.zpool.ca:6033 -u 9P124xJj1Sq9HgPemLcxLdBxSKn2WYUQ5Q -p c=XMG,zap=XMG -t 8
